...
/**
 * @title Filend's FErc20Delegator Contract
...
contract FErc20Delegator is FTokenInterface, FErc20Interface, FDelegatorInterface {
    /**
     ...
     * @return uint 0=success, otherwise a failure (see ErrorReporter.sol for details)
     */
    function liquidateBorrow(address borrower, uint repayAmount, FTokenInterface fTokenCollateral) override external returns (uint) {
     ...
     * @dev This is used by filtroller to more efficiently perform liquidity checks.
   ...
   /**
    ...
    /**
      * @notice Sets a new filtroller for the market
      * @dev Admin function to set a new filtroller
      * @return uint 0=success, otherwise a failure (see ErrorReporter.sol for details)
      */
