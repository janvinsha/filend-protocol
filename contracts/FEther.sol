...
contract FEther is FToken {
    /**
     * @notice Construct a new FEther money market
    ...
    constructor(FiltrollerInterface filtroller_,
        ...
        initialize(filtroller_, interestRateModel_, initialExchangeRateMantissa_, name_, symbol_, decimals_);
    ...
    /**
     * @notice Send Ether to FEther to mint
     */
